...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    item = ItemMO(context: appDelegate.persistentContainer.viewContext)
    item.description = "Молоко Простоквашино"
    
    
    
//    let appDelegate = (UIApplication.shared.delegate as? AppDelegate)
//    var item = ItemMO(context: appDelegate.persistentContainer.viewContext)
    //    item.descriptionText = "Молоко Простоквашино"
